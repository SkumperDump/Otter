...
// IWYU pragma: private, include "Fonts/FontCache.h"
...
#define CURRENT_FILE_ID FID_Engine_Source_Runtime_SlateCore_Public_Fonts_FontCache_h
...
template<> struct TIsUEnumClass<ETextShapingMethod> { enum { Value = true }; };
