...
// IWYU pragma: private, include "Layout/FlowDirection.h"
...
#define CURRENT_FILE_ID FID_Engine_Source_Runtime_SlateCore_Public_Layout_FlowDirection_h
...
template<> struct TIsUEnumClass<EFlowDirectionPreference> { enum { Value = true }; };
