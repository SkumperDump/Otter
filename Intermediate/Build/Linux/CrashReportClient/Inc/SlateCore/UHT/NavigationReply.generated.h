...
// IWYU pragma: private, include "Input/NavigationReply.h"
...
#define CURRENT_FILE_ID FID_Engine_Source_Runtime_SlateCore_Public_Input_NavigationReply_h
...
template<> struct TIsUEnumClass<EUINavigationRule> { enum { Value = true }; };
