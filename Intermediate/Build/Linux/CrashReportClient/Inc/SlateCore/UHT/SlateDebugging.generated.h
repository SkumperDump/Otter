...
template<> struct TIsUEnumClass<ESlateDebuggingInputEvent> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ESlateDebuggingStateChangeEvent> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ESlateDebuggingNavigationMethod> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ESlateDebuggingFocusEvent> { enum { Value = true }; };
