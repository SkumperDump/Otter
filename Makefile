...
GAMEPROJECTFILE =/home/skump/Documents/Unreal Projects/Otter/Otter.uproject
...
Otter-Linux-Debug:
	 $(PROJECTBUILD) Otter Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Otter-Linux-DebugGame:
	 $(PROJECTBUILD) Otter Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Otter-Linux-Test:
	 $(PROJECTBUILD) Otter Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Otter-Linux-Shipping:
	 $(PROJECTBUILD) Otter Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Otter:
	 $(PROJECTBUILD) Otter Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

OtterEditor-Linux-Debug:
	 $(PROJECTBUILD) OtterEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

OtterEditor-Linux-DebugGame:
	 $(PROJECTBUILD) OtterEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

OtterEditor-Linux-Test:
	 $(PROJECTBUILD) OtterEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

OtterEditor-Linux-Shipping:
	 $(PROJECTBUILD) OtterEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

OtterEditor:
	 $(PROJECTBUILD) OtterEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
